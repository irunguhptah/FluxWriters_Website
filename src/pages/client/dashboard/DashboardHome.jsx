...
export default function DashboardHome() {
  ...
  const notifications = [
    {
      ...
      message:
        'Your "Business Case Study Analysis" is complete. Please review and provide feedback.',
      time: "2 hours ago",
      read: false,
      type: "completion",
    },
    {
      ...
      message:
        'Dr. Smith has been assigned to your "Computer Science Research Paper"',
      time: "1 day ago",
      read: false,
      type: "assignment",
    },
  ...
  // Chat state removed as unused

  // Handlers for user actions
  const handleTrackOrder = () => {
    // Navigate to new order page (no toast needed)
  };
  const handleTabSwitch = (tab) => {
    // Switch tab silently
  };
  const handleOrderDetails = (order) => {
    // Navigate to order details (no toast needed)
  };
  const handleViewAllOrders = () => {
    // Navigate to orders page (no toast needed)
  };
  const handleViewAllNotifications = () => {
    // Navigate to notifications (no toast needed)
  };
  const handleViewAllMessages = () => {
    // Navigate to messages (no toast needed)
  };
  const handleNotificationClick = (notification) => {
    // Handle notification click (no toast needed)
  };
  const handleChatClick = (chat) => {
    // Open chat (no toast needed)
  };

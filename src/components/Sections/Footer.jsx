        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              Premium academic writing services to elevate your educational
              journey.
            </p>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-700">
                  123 Academic Lane, Education City
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-3 mt-1">📧</span>
                <a
                  href="mailto:contact@fluxwriters.com"
        ...
        <div className="border-t border-gray-300 pt-6 flex flex-col md:flex-row justify-between items-center">
          <div className="text-center md:text-left mb-4 md:mb-0">
            <p className="text-gray-500 text-sm">
              © {getCurrentYear()}{" "}
              <span className="text-purple-400 font-medium">FluxWriters</span>.
              All Rights Reserved.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
            ...
            >
              <span className="mr-2 transform group-hover:-translate-y-1 transition-transform">
                ↑
              </span>
              Back to Top
            </Link>
            <div className="flex space-x-4">
              ...
              <button
                onClick={() => console.log("Navigate to Cookie Policy")}
                className="text-gray-500 hover:text-white text-sm transition-colors"
              >
                Cookie Policy
              </button>
